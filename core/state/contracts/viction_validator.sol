...
// solc --allow-paths ., --abi --bin --overwrite --optimize -o core/state/contracts/build core/state/contracts/viction_validator.sol
// abigen -abi core/state/contracts/build/VictionValidator.abi -bin core/state/contracts/build/VictionValidator.bin -pkg contracts -type viction_validator -out core/state/contracts/gen_viction_validator.go
